...
class Tower(arcade.Sprite):
    def __init__(self, hp= 0, tower_path= 'tower.png'):
        super().__init__()
        self.hp = hp
    ...
    def attacked(self, damage):
        ...
        if self.hp <= 0:
            self.destroyed = True
            self.texture = self.texture_destroyed
...
TOWER_4 = Tower()
LINES = []
LINES.append((FRIENDLY_POKE_QUEUE_0, ENEMY_POKE_QUEUE_0, TOWER_0))
LINES.append((FRIENDLY_POKE_QUEUE_1, ENEMY_POKE_QUEUE_1, TOWER_1))
LINES.append((FRIENDLY_POKE_QUEUE_2, ENEMY_POKE_QUEUE_2, TOWER_2))
LINES.append((FRIENDLY_POKE_QUEUE_3, ENEMY_POKE_QUEUE_3, TOWER_3))
LINES.append((FRIENDLY_POKE_QUEUE_4, ENEMY_POKE_QUEUE_4, TOWER_4))
